    ...
    public partial class ServiceRequest : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (ddlServiceType.SelectedValue != "")
            {
                ...
                createRequest.CommandText = "INSERT INTO dbo.SERVICEREQUEST (serviceType, requestTimeDate, requestDescription, requestSeen, customerID) VALUES(@ServiceType, GETDATE(), @RequestDescription, @RequestSeen, @CustomerID)";
